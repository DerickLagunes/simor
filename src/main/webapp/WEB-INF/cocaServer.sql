...
CREATE TABLE evaluacion (
                            ...
                            llantas_profundidad_delantera_izquierda DECIMAL(4,2) NOT NULL,
                            llantas_profundidad_delantera_derecha DECIMAL(4,2) NOT NULL,
                            llantas_profundidad_trasera_izquierda_1 DECIMAL(4,2) NOT NULL,
                            llantas_profundidad_trasera_izquierda_2 DECIMAL(4,2) NOT NULL,
                            llantas_profundidad_trasera_derecha_1 DECIMAL(4,2) NOT NULL,
                            llantas_profundidad_trasera_derecha_2 DECIMAL(4,2) NOT NULL,
