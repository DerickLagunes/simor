...
@WebServlet(name="VerEvaluacionClienteServlet", value = "/verEvaluacionCliente")
public class VerEvaluacionClienteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.sendRedirect("verEvaluacionCliente.jsp");
    }
